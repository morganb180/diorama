/**
 * Generate famous homes for launch tweets
 */
import fs from 'fs';
...
const HOMES = [
  ...
  { id: 'farnsworth', name: 'Farnsworth House', address: '14520 River Rd, Plano, IL 60545' },
...
const STYLES = [
  { id: 'diorama', prompt: '45-degree isometric miniature architectural diorama model. Studio photography, warm lighting, clean white background. High-end architectural scale model aesthetic.' },
  { id: 'ghibli', prompt: 'Studio Ghibli anime background painting style. Warm afternoon sunlight, hand-painted watercolor textures, puffy clouds, peaceful dreamy atmosphere.' },
  { id: 'openarmy', prompt: '1980s GI Joe military action figure playset. Camo patterns, sandbags, radar dishes, molded plastic toy aesthetic. Product photography on white background.' },
];
...
async function main() {
  console.log('🚀 Generating launch assets for', HOMES.length, 'famous homes');
