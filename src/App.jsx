...
// AI Chatbot Icons
function ChatGPTIcon({ className = "w-10 h-10" }) {
  return (
...
function ClaudeIcon({ className = "w-10 h-10" }) {
  // Official Claude starburst logo from Bootstrap Icons
  return (
...
function GeminiIcon({ className = "w-10 h-10" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
function GrokIcon({ className = "w-10 h-10" }) {
  // Official Grok logo - spiral/swirl design (no background)
  return (
    <svg className={className} viewBox="50 55 420 400" fill="currentColor">
...
const AI_SERVICES = [
  ...
  },
  {
    name: 'Grok',
    icon: GrokIcon,
    url: `https://x.com/i/grok?text=${encodeURIComponent(AI_PROMPT)}`,
  },
];
  ...
  return (
    <section className="relative z-10 py-16 px-6">
      <div className="max-w-2xl mx-auto text-center">
        <div className="bg-void-100/50 backdrop-blur-sm rounded-2xl border border-void-300 p-8">
